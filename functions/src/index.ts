...
// FIX 2: Revert to Node.js require() and assign directly for module compatibility
...
export const fetchNews = onRequest(
    ...
    if (!isAuthenticated(req)) {
        res.status(401).send({ error: "Unauthenticated: Missing Authorization header." });
        return;
    }
    ...
    const data: FetchNewsData = {
        ...
        languageCode: req.query.languageCode as string || req.body.languageCode as string,
    };
...
export const createLesson = onRequest(
    ...
    const data: CreateLessonData = {
        articleUrl: req.query.articleUrl as string || req.body.articleUrl as string,
    ...
    try {
        ...
        if (articleContent.length < 100) {
            throw new Error(
                "Could not extract meaningful article content. Website too complex or blocked."
            );
        }
                    ...
                    properties: {
                                ...
                                properties: {
                                    ...
                                    articleExample: { 
                                        ...
                                        description: "A sentence or phrase containing the word, " +
                                            "copied directly from the article text." 
                                    }
                                },
                                required: [
                                    "word", 
                        ...
                        comprehensionQuestions: {
                            ...
                            description: "3-5 questions testing understanding of the main " +
                                "points, appropriate difficulty for the user's level."
                        },
                        grammarFocus: {
                            type: "OBJECT",
                            properties: {
